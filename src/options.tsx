...
const create_initial_state = ( options: Options ): State & Opened =>
    ( open( { options } ) );


export { State, render as Render, mouseMoved, clicked, keydown, create_initial_state, getOptions, getValue, is_opened };